...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
         ...
         //code to get username  from user
        ...
        while (true) {
            ...
            while (true) {
                ...
                String s = scan.nextLine();
              //code to get password from user
                ...
                for (boolean playersTurn = true; win == 0; playersTurn ^= true) {
                    ...
                    } else
                    {
                        ...
                        for (choiceIndex = 0; choiceIndex < compdeck.size(); choiceIndex++) {
                            if (((GroupOfCards) compdeck.get(choiceIndex)).canPlace(topCard, currentColor)) 
                            {
                                break;
                            }
                        }
